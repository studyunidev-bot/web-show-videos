                  ...
                  return (
                    <li key={itemIdx} className="relative z-10 mb-0.5 last:mb-0">
                      <button
                        ...
                        className={`relative w-full text-left pl-7 pr-2 py-1.5 rounded-md transition-colors outline-none text-sm sm:text-base ${
                          isActive 
                      ...
                      >
                        {/* Dot */}
                        <div className={`absolute left-[5.5px] top-[13px] w-1.5 h-1.5 rounded-full ${
                          isActive ? 'bg-[#1e3a8a] ring-4 ring-[#d1e3ff]' : 'bg-[#1e3a8a]'
                        }`}></div>
                        
                        <div className={`flex flex-wrap ${isActive ? 'text-[#1e3a8a]' : 'text-[#334155]'}`}>
                          <span className="w-[60px] sm:w-[70px] flex-shrink-0">{item.label}</span>
